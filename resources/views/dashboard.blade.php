<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- HERO SECTION (Sapaan User - Style: Bright Gradient) --}}
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 mb-8 relative overflow-hidden shadow-lg">
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    ...
                    {{-- Unique Icon Block (No Border) --}}
                    <div class="hidden md:block">
                        <div class="bg-white/10 p-4 rounded-xl shadow-lg transform rotate-3 backdrop-blur-sm flex items-center justify-center">
            ...
            {{-- NOTIFIKASI --}}
            @if(session('success'))
                <div class="bg-green-100 border-l-4 border-green-600 text-green-800 p-4 mb-6 rounded-r shadow-sm flex items-start gap-3">
                    <svg class="w-6 h-6 text-green-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <div>
            ...
            {{-- BAGIAN 1: PILIHAN PENGAJUAN (RE-DESIGNED) --}}
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                
                {{-- Opsi 1: Fasilitasi (Gratis) --}}
                <div class="group bg-white rounded-2xl p-8 border border-blue-100 shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col relative overflow-hidden">
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex justify-between items-start mb-6">
                            {{-- Icon Wrapper (Tanpa Border/Shadow Inner) --}}
                            <div class="w-14 h-14 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-3xl">
                                🎁
                            </div>
                            {{-- Status Badge --}}
                            @if($kuotaPenuh)
                                <span class="bg-red-50 text-red-600 border border-red-200 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide flex items-center gap-1">
                                    <span class="w-2 h-2 bg-red-500 rounded-full"></span> Penuh
                                </span>
                            @else
                                <span class="bg-blue-50 text-blue-600 border border-blue-200 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide flex items-center gap-1">
                ...
                <div class="group bg-white rounded-2xl p-8 border border-indigo-100 shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col relative overflow-hidden">
                    {{-- Background Decoration --}}
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex justify-between items-start mb-6">
                            ...
                            {{-- Status Badge --}}
                            <span class="bg-indigo-50 text-indigo-600 border border-indigo-200 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide flex items-center gap-1">
